...
def initialize_hybrid_retriever() -> HybridRerankerRetriever:
    """Initialize and return the enhanced hybrid retriever"""
    ...
    return HybridRerankerRetriever(vector_store=vector_store)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        for i, doc in enumerate(results, 1):
            ...
            print(f"Confidence: {doc.metadata['combined_score']:.2f}")
